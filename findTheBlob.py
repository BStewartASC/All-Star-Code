...
#While what im looking at isnt blue continue to rotate
#go forward
red = 1
green = 2
blue = 3
...
pic = takePicture()
colorSpotPosition = findColorSpot(pic,blue)
print (colorSpotPosition)


while (colorSpotPosition != -1):
    pic = takePicture()
    colorSpotPosition = findColorSpot(pic,blue)
    print (colorSpotPosition)
    if findColorSpot(pic,blue) == 0:
        turnBy(45, "deg")
    else:
        stop()
        forward(1,5)
